<template>
  ...
  >
    ...
    <div class=" h-48  mb-8 w-72 rounded-xl bg-gray-800 py-8 px-6 shadow-lg">
      ...
      <section class="mt-4">
        ...
        />
        <p
        class="mt-1.5 animate-pulse text-center text-red-600"
        v-if="!!error"
      >
        {{ error }}
      </p>
...
export default {
  ...
  methods: {
    submit() {
      ...
      this.$store.dispatch('attendance/initSession',payload);
